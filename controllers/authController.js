...
const forgotPassword = async (req, res) => {
  ...
  if (user) {
    ...
    throw new CustomError.BadRequestError('User with that email does not exist');
  }
...
const resetPassword = async (req, res) => {
  ...
  if (user) {
    ...
    if (user.passwordToken === createHash(token) && user.passwordTokenExpirationDate > currentDate) {
      ...
      throw new CustomError.BadRequestError('Reset Password Token expired!');
    }
  }
  else{
    throw new CustomError.BadRequestError('Invalid Value of email');
  }
